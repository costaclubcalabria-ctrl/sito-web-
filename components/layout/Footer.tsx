 ...
 * Il footer.
 *
 * È l'unica superficie scura del sito, e non è una scelta estetica: dopo una
 * pagina interamente chiara serve un fondo che dica "qui finisce". Il vetro non
 * c'entra: il vetro galleggia sopra qualcosa, e qui sotto non c'è più niente.
 */
export function Footer() {
  return (
    <footer className="relative z-10 mt-0 bg-carbone text-white">
      <div className="content-grid py-16">
        <div className="mt-14 grid gap-12 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            ...
            <p className="mt-6 max-w-xs text-sm" style={{ color: 'rgb(255 255 255 / 0.68)' }}>
          ...
          <nav aria-label={t.footer.navigazione}>
            <h2 className="font-mono text-quota tracking-[0.1em] uppercase" style={{ color: 'rgb(255 255 255 / 0.45)' }}>
              {t.catalogo.titolo}
            </h2>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              <li>
                <Link href="/contatti" className="text-sm transition-colors hover:text-white" style={{ color: 'rgb(255 255 255 / 0.68)' }}>
                  {t.nav.contatti}
                </Link>
              </li>
              <li>
                <Link href="/su-richiesta" className="text-sm transition-colors hover:text-white" style={{ color: 'rgb(255 255 255 / 0.68)' }}>
                  {t.nav.suRichiesta}
                </Link>
              </li>
            </ul>
        ...
        <div
          ...
          style={{ borderColor: 'rgb(255 255 255 / 0.16)', color: 'rgb(255 255 255 / 0.45)' }}
        >
          <p>
